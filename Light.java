...
public class Light {
  ...
  private Mat4 modelMatrix=Mat4Transform.rotateAroundZ(0);
  ...
  public void render(GL3 gl) { 
    ...
    model = Mat4.multiply(Mat4Transform.translate(position), model);// this position is changing all the time
